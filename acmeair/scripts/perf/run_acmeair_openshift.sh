...
# Ex of ARGS :  wobbled.os.fyre.ibm.com openshift-monitoring /acmeair/results 400 300 5 3
...
function runIterations() {
        ...
        do
                ...
                ./scripts/acmeair-deploy-openshift.sh $BENCHMARK_SERVER $NAMESPACE $MANIFESTS_DIR $RESULTS_DIR_ITR $SCALING
                fi
                # Start the load
