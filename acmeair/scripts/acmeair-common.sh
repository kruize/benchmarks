...
JMETER_DEFAULT_IMAGE="shruthi07acharya/jmeter_acmeair:3.1"
ACMEAIR_DEFAULT_IMAGE="dinogun/acmeair-monolithic"
JMETER_CUSTOM_IMAGE="jmeter_acmeair:3.1"
...
function build_jmeter() {
	docker build --pull -t ${JMETER_CUSTOM_IMAGE} -f Dockerfile.jmeter . 2>>${LOGFILE} >>${LOGFILE}
}
